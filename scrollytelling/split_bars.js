var split_bars = function() {
  var margin = {top: 130, right: 30, bottom: 70, left: 400},
  ...
  const bandwith_old = 400;
  const bandwith_new = 300;
  ...
  svg.append("rect")
    .attrs({width:bandwith_old, height: 280, x:bandwith_old,
            y:100, fill: initial_color, id: "right"});
  ...
  function split(mode=d3.easePoly) {
    ...
    .ease(mode)
    .duration(1500)
    .attrs({width:bandwith_new, x:x_shift, height: 180, y:200, fill:"red"});
